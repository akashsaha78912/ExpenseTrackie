...
export function BudgetProgress({ initialBudget, currentExpenses }) {
    ...
    const [newBudget, setNewBudget] = useState(((_a = initialBudget === null || initialBudget === void 0 ? void 0 : initialBudget.amount) === null || _a === void 0 ? void 0 : _a.toString()) || "");
    ...
    const handleCancel = () => {
        var _a;
        setNewBudget(((_a = initialBudget === null || initialBudget === void 0 ? void 0 : initialBudget.amount) === null || _a === void 0 ? void 0 : _a.toString()) || "");
        setIsEditing(false);
    };
    useEffect(() => {
        if (updatedBudget) {
