...
export function TransactionTable({ transactions }) {
    ...
    const filteredAndSortedTransactions = useMemo(() => {
        ...
        if (searchTerm) {
            ...
            result = result.filter((transaction) => { var _a; return (_a = transaction.description) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchLower); });
        }
        // Apply type filter
        if (typeFilter) {
    ...
    const handleSelectAll = () => {
        setSelectedIds((current) => current.length === paginatedTransactions.length
            ? []
    ...
    return (<div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <Input placeholder="Search transactions..." value={searchTerm} onChange={(e) => {
          ...
          <TableHeader>
            <TableRow>
              <TableHead className="w-[50px]">
                <Checkbox checked={selectedIds.length === paginatedTransactions.length &&
            paginatedTransactions.length > 0} onCheckedChange={handleSelectAll}/>
              </TableHead>
          ...
          <TableBody>
            {paginatedTransactions.length === 0 ? (<TableRow>
                ...
                background: categoryColors[transaction.category],
                  ...
                  <TableCell className={cn("text-right font-medium", transaction.type === "EXPENSE"
                ? "text-red-500"
                : "text-green-500")}>
