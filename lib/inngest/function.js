...
export const processRecurringTransaction = inngest.createFunction({
    ...
    var _a, _b;
    // Validate event data
    if (!((_a = event === null || event === void 0 ? void 0 : event.data) === null || _a === void 0 ? void 0 : _a.transactionId) || !((_b = event === null || event === void 0 ? void 0 : event.data) === null || _b === void 0 ? void 0 : _b.userId)) {
    ...
    for (const user of users) {
        await step.run(`generate-report-${user.id}`, async () => {
            ...
            await sendEmail({
                ...
                react: EmailTemplate(emailTemplateProps),
            });
        });
    }
...
async ({ step }) => {
    ...
    for (const budget of budgets) {
        ...
        await step.run(`check-budget-${budget.id}`, async () => {
            ...
            const totalExpenses = ((_a = expenses._sum.amount) === null || _a === void 0 ? void 0 : _a.toNumber()) || 0;
