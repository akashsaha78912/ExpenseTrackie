    ...
    return (<Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        ...
        <div className="px-4 pb-4">
          {/* Use type assertion to fix the handleSubmit issue */}
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="balance" type="number" step="0.01" placeholder="0.00" {...form.register("balance")}/>
              {form.formState.errors.balance && (<p className="text-sm text-red-500">{form.formState.errors.balance.message}</p>)}
            </div>
            ...
            <div className="flex items-center justify-between rounded-lg border p-3">
              ...
              <Switch id="isDefault" checked={form.watch("isDefault") || false} onCheckedChange={(checked) => form.setValue("isDefault", checked)}/>
            </div>
